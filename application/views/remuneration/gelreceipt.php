...
<!--form id="regForm"-->
        <?php echo form_open('formreceipt') ?>
        <!--傳送到哪個controller-->
                ...
                <div class="field">
                    ...
                    <table>
                      <tr>
                        <td>收受人:</td>
                        <td><input type="text" name="receivename" class="form-control" id="formGroupExampleInput" placeholder="ex:王曉明"></td>
                      ...
                      <tr>
                        <td>日期:</td>
                        <td><input type="date" name="date" class="form-control" id="formGroupExampleInput2" placeholder=""></td>
                      </tr>
                      <tr>
                        <td>金額:</td>
                        <td><input type="text" name="amount" class="form-control" id="formGroupExampleInput2" placeholder=""></td>
                      </tr>
                ...
                <div align="right" style="margin:10px auto; width:40%" class="div_btnacut">
                    <input type="submit" class="btn btn-info" value="會計寄出" />
                </div>
            ...
            <div class="tab" style="width:80%;margin:0px auto;">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="formGroupExampleInput" placeholder="ex:">
              </div>
              <div class="form-group">
...
<?
  if($auth=="accountant")
  {
    echo "<script type=\"text/javascript\">
      ...
      $(\"#asign\").attr(\"disabled\",\"disabled\");
      $(\"#twdid\").attr(\"disabled\",\"disabled\");
      $(\"#localname\").attr(\"disabled\",\"disabled\");
